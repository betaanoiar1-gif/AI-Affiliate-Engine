...
def test_intelligence_rewards_persistent_intent_and_flags_risk():
    result = assess_opportunity(make_offer(), TrendObservation("trends", "ai tools", 90, 80, 85, 70, 20), "DZ")
...
def test_intelligence_blocks_ineligible_offer():
    result = assess_opportunity(make_offer(eligible_countries=["US"]), TrendObservation("x", "x", 90, 90, 90, 90, 10), "DZ")
