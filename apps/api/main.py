...
from core.domain import Offer, Signal, RunMode
from core.scoring import score_offer
from core.simulation import simulate
from core.policies import PolicyEngine

app = FastAPI(title="AI Affiliate Engine", version="0.1.0")
policy = PolicyEngine()
...
def capabilities():
    return {
        "modules": ["research", "offers", "scoring", "content", "simulation", "policies", "analytics"],
        "publishing": False,
        "ai_provider": "adapter-based",
        "affiliate_provider": "adapter-based",
    }
